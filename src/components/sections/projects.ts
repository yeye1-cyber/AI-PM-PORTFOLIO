...
export const supportFeatures: SupportFeature[] = [
  {
    ...
    paragraphs: [
      "学习 AI、准备求职或推进个人项目时，知识工作者常因信息过载、任务堆积和自我否定而难以开始。",
      "普通待办工具只能记录任务；通用聊天机器人虽然能够安慰，却容易回应空泛，难以延续到实际行动。因此，我设计了一个既能理解情绪，又能帮助用户重新启动行动的 AI 产品。",
    ],
  },
  {
    id: "positioning", label: "产品定位", number: "02", title: "先接住情绪，再陪用户动一步",
    conclusion: "接住猫位于“情绪陪伴”和“任务管理”之间，核心价值主张是：先接住情绪，再陪你动一步。",
    paragraphs: [
